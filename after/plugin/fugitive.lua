...
local ThePrimeagen_Fugitive = vim.api.nvim_create_augroup("Custom_Fugitive", {})
...
autocmd("BufWinEnter", {
    ...
    callback = function()
        ...
        vim.keymap.set("n", "<leader>t", ":Git push -u origin ", {buffer = bufnr, remap = false, desc = "Se[t] upstream and push"});
    end,
})
